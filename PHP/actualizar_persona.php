    ...
    <main class="container my-5 h-100">
        <section class="section section-auth">
            <div class="wrapper-box">
                <h3 class="title">Actualizar Persona</h3>
                <form class="form" id="sign-up-form" action="actualizarPersona.php" method="POST">
                    ...
                    <div class="form-field">
                        ...
                        <input class="form-control" type="text" id="primer_nombre" name="primer_nombre" required />
                    </div>
                    <div class="form-field">
                    ...
                    <input class="button mb-1" type="submit" value="Actualizar Persona" />
                </form>
            </div>
        </section>
    </main>
