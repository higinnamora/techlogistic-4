    ...
    <main class="container my-5 h-100">
        ...
        <div class="table-responsive">
            ...
            if (isset($_GET['numero'])) {
                $numero = $_GET['numero'];
                $sql = "SELECT ov.numero_orden_venta, ov.fecha_factura, ov.doc_identidad, ov.nombre_cliente, p.nombre_producto, dv.cantidad, dv.subtotal
                        FROM orden_venta ov
                        INNER JOIN detalle_venta dv ON ov.numero_orden_venta = dv.numero_orden_venta
                        INNER JOIN producto p ON p.codigo_producto = dv.producto
                ...
                if ($datos->num_rows > 0) {
                    ...
                    echo "
                        <tr>
                            ...
                            <td>{$row_primero['nombre_producto']}</td>
