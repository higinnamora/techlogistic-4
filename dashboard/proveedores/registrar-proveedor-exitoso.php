...
<head>
  ...
  <!-- Estilos CSS -->
  <link rel="stylesheet" href="../../sSTYLES/techlogistic.css">
  ...
  <main class="main">
    <section class="section section-gif">
      ...
      <h1 class="text-center mb-5">
        Registro de proveedor exitosa
      </h1>
      <a href="./indexproveedores.php"><button class="button">Volver a la página de proveedores</button></a>
    </section>
