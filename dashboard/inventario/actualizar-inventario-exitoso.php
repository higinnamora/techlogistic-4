  ...
  <main class="main">
    <section class="section section-gif">
      ...
      <h1 class="text-center mb-5">
        Actualizacion de inventario exitosa
      </h1>
      <a href="./indexinventario.php"><button class="button">Volver a la página de inventario</button></a>
    </section>
    <footer class="copyright">
      <div class="bd-container">
        <p>💙 © 2024 Techlogistic. Todos los derechos reservados. 💚</p>
        <p><a href="../PHP/terminos-y-condiciones.html">Términos y Condiciones</a> · <a href="../PHP/politica-de-privacidad.html">Política de Privacidad</a></p>
      </div>
    </footer>
  </main>
